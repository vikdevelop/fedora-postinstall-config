...
installing_timeshift = "→→→ installing timeshift ..."
installing_make = "→→→ installing make ..."
...
installing_flatseal = "Installing Flatseal ..."
